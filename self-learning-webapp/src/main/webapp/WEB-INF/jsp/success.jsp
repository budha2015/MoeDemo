...
<head>
  ...
  <link href="${pageContext.request.contextPath}/css/tprm.css" rel="stylesheet">
  <link href="${pageContext.request.contextPath}/css/qcss.css" rel="stylesheet">
		...
		<div class="container">
 			...
 			<div class="containerPanel clearfix">
 				 <div class="alert alert-success" >
				     <h4 class="text-center">  Record saved successfully. </h4>
