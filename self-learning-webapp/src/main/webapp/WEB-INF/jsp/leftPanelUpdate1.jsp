 <!-- This is only visible to small devices -->
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href=""><img src="images/onboarding_normal.png" class="pr10"> <span>User Management</span></a>
		<ul class="children">
	...
	<!-- Organisation management menu -->
	<li class="nav-parent"><a href=""> <img src="images/internal_normal.png" class="pr10" > <span>Internal Organisation</span></a>
		<ul class="children">
			...
			<form id="searchorgform" method="post"
           	...
           	<!-- Template menu -->
	<li class="nav-parent"><a href=""> <img src="images/email_normal.png" class="pr10"><span>Email Template </span></a>
		<ul class="children">
	...
	<li class="nav-parent"><a href=""><img src="images/external_normal.png" class="pr10"> <span>External Organisation</span></a>
		<ul class="children">
	...
	<li class="nav-parent"><a href=""><img src="images/Comments_normal.png" class="pr10"> <span>Comments</span></a>
		...
		<!-- Questionnaire menu -->
	<li class="nav-parent"><a href=""><img src="images/Questionnaire-Management_normal.png" class="pr10"><span>Questionnaires</span></a>
		<ul class="children">
		...
		<!-- Contract menu -->
	<li class="nav-parent"><a href=""><img src="images/Partner-Management_normal.png" class="pr10"> <span>Initiate Contract</span></a>
		<ul class="children">
