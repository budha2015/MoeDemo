...
<form name="qbank">
	...
	<div class="innerHeading">
		<!-- <h1>Questionnaires / Business case</h1> -->
		<h1>Data Collection Assign</h1>
					...
					<div class="radio-container">
						...
						<!-- <form action="questionnairelinking"> -->
							<input type="radio" id="qst" name="deftype" class="radioBtn" value="Q"><label for="qst">Questionnaires</label>
							<input type="radio" id="bCase" name="deftype" class="radioBtn" value="B" checked><label for="bCase">Business Case</label>
...
<!-- leftpanel -->
	...
	<div class="container">
		<div class="row">
		   <div class="RM_datatable_tab">			
				<form id="displayrecievedtaskform" method="post" action="/partnerintegrity/assigndatacollection">
					<span id="rec_task" class="active_tab" onclick="document.getElementById('displayrecievedtaskform').submit();">Data Collection Assign</span>
				</form>
				
				<form id="displaysenttask" method="post" action="/partnerintegrity/responsedatacollection">
					<span id="send_task" onclick="document.getElementById('displaysenttask').submit();">Data Collection Response</span>
				</form>
			</div>
		</div>
		<div class="dataTableContainer">
			...
			<thead class="head">
				<tr>
				<!-- <th class="th_border hidden" style="padding-left:10px;"><input type="checkbox" id="selecctall" /><label></label></th> -->
				...
				<th class="qb_question filterHead th_border">Name <b><span></span>
					...
					<th class="assignto qb_startDate filterHead">Assign to</th>
				...
				<i class="fa closeBtn"></i>
					...
					<li class="closeCancelBtn"><button type="button"
						...
						<button type="button" class="btn btn-xs submitQ sQ" name="submitQ"
							disabled="disabled">Send</button></li>
				</ul>
			</div>
		</form>
	</div>
		...
		<div class="responseConfirm reponses">
			<div>
				<p class="qtName"><b>${questionnaireName}</b></p> <input
					...
					name="linkId"> <i
					class="fa fa-times-circle closeBtn"></i>
			</div>
			<table>
				<thead class="head">
...
jQuery(document).ready(function(){
	...
	if(checkState==true){
		...
		console.log("In side if" + jQuery("#sendToTP").val());
	}else{
		jQuery("#sendToTP").val(false);
		console.log("In side else" + jQuery("#sendToTP").val());
	}
