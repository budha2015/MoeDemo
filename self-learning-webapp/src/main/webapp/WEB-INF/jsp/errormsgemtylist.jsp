...
<section>
  ...
  <div class="alert alert-success" >
      ...
      <table align="center">
         <tr><td>
   <!--     <button onclick="goBack()" ><h4 class="btn btn-success btn-block">Go Back</h4></button> -->
       <button onclick="goBack()" class="btn btn-success btn-block" name="back" type="submit">Go Back</button>
     </td>
     </tr>
       </table>
