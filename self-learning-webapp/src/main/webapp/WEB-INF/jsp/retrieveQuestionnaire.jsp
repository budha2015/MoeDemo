...
.multiChoice_dd {width: 420px; float:left}
.mc_dd_opt {width: 420px}
...
.yesBtn, .bBtn, .noBtn{width: 75px; margin-top:10px;}
.yesBtn, .bBtn {margin-right: 20px; margin-left: 25px}
.noBtn {float:right;}
.leftpanel {
    background: none repeat scroll 0 0 #3b3b3b;
    left: 0;
...
.icon-settings, .icon-delete, .branch-delete { cursor: pointer;}
.settings-panel td { vertical-align: top; padding:5px 0 4px 5px}
...
.tab .sectionInput:hover {   border-color: rgb(48, 91, 127);}
...
.questHeader .questBtnGlobal .fl {margin-left: 18px}
...
Set<Map.Entry<String,LinkedList<QuestionComponent>>> set = sectionMap.entrySet();
 ...
 while(iterator.hasNext()){
	 ...
	 sectionNameBasedLiContent += "<li class='tab active' data-link='sectionTitle"+st+"'><input name='sectionTitle"+st+"51' class='sectionInput' id='sectionTitle"+st+"51' value='"+(mEntry.getKey()!=null?mEntry.getKey():"")+"'><input name='questionnaireId' class='sectionQuestionnaire hidden' value='"+(((mEntry.getValue()).get(0)).getQuestionnaireId()!=null?((mEntry.getValue()).get(0)).getQuestionnaireId():0)+"'><span class='deleteQst'></span></li>";
...
if(questionTypeId.equals("13")){
	  ...
	  businessContent += "<tr><td class='bleft'>Company's full legal name</td><td class='bright'><input type='text' class='search-table' value='"+ (qc.getLegalName() != null?qc.getLegalName():"") +"'/>";  
...
//System.out.println("((qc.getQuestionAttachment()).booleanValue()==true======"+((qc.getQuestionMandatory()).booleanValue()));
	...
	String deleteIcon = qc.isBranched()?"branch-delete":"icon-delete";
	
	myContent+="<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='singleTxtFields boxContainer'><div class='qt_settings clearfix'><i class='icon-sTxtBox icons'></i><span class='widgetName'>Single Text Box</span><ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") + "'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox'><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button> </div> </li> <li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'>	<div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label> <span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt clearfix'><div class='clearfix'><label class='qt_ansOpt'>Answer</label></div><ul><li class='clearfix'><input class='hidden' name='qt' type='text' value='1'>";
			int i = 0;
	...
	//	}
			myContent+="<input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
	}
	catch(Exception e1){
		e1.printStackTrace();
	}
...
/*	Iterator iter = answerOptionValueList.iterator();
	...
	try{
		String deleteIcon = qc.isBranched()?"branch-delete":"icon-delete";
	myContent+=	"<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='multipleTxtBox boxContainer'><div class='qt_settings clearfix'><i class='icon-mTxtBox icons'></i><span class='widgetName'>Multi text box</span><ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox'><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox'><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li> </ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_multi clearfix'><div class='clearfix'><label class='qt_ansOpt'>Answers</label></div><input class='hidden' name='qt' type='text' value='2'><ol class='qt_multiTxtBoxList widgetsEl' type='a'>";
...
/* 		for(int i = 0;i<answerOptionValueList.size();i++){
		...
		try{
			String deleteIcon = qc.isBranched()?"branch-delete":"icon-delete";
			myContent+="<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='singleTxtFields boxContainer'><div class='qt_settings clearfix'><i class='icon-nBox icons'></i><span class='widgetName'>Numeric box</span><ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox'><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button> </div> </li> <li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'>	<div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label> <span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt clearfix'><div class='clearfix'><label class='qt_ansOpt'>Answer</label></div><ul><li class='clearfix'><input class='hidden' name='qt' type='text' value='1'>";
					int i = 0;
...
/*		Iterator iter = answerOptionValueList.iterator();
		...
		int i=0;
			try{
				...
				String deleteIcon = qc.isBranched()?"branch-delete":"icon-delete";
		myContent += "<li id='currency-box' class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='currencyBox boxContainer'><div class='qt_settings clearfix'><i class='icon-cBox icons'></i><span class='widgetName'>Currency box</span><ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li> </ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><input class='hidden' name='qt' type='text' value='4'><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_multi clearfix'><div class='clearfix'><label class='qt_ansOpt col1'>Answer</label></div><div class='clearfix'>";
		if(answerOptionValueList !=null)
		myContent+="<select class= 'qtCatCurrency currency' name='a'><option "+(currency.equalsIgnoreCase("USD")?"selected":"")+">USD</option><option "+(currency.equalsIgnoreCase("POUND")?"selected":"")+">POUND</option> <option "+(currency.equalsIgnoreCase("RUPEE")?"selected":"")+">RUPEE</option> </select><input class='qt_ansOpt submt currencyInput' name='a' readonly='true' type='text' value='"+amount+"'></div><label class='setRange'>Set range</label><div class='clearfix'></div><div class='clearfix'><label class='col1'>Min. value</label><label class='col2'>Max. value</label><label class='col3 qt_score'>Score</label></div><ul class='qt_multiTxtBoxList widgetsEl'><li class='clearfix qt_multiTxtBox_row hidden'><input class='col1' name='from' type='text'><input class='col2' name='to' type='text'><input class='qt_score submt' name='s' maxlength=5 type='text' value='' ><button class='qt_add'><button class='qt_remove'></button></li>";
		...
		//myContent+="<li class='clearfix qt_multiTxtBox_row'><input class='col1' name='from' type='text' value='"+answerOptionValueList.get(i).substring(0,answerOptionValueList.get(i).indexOf("to"))+"'><input class='col2' name='to' type='text' value='"+answerOptionValueList.get(i).substring(answerOptionValueList.get(i).indexOf("to")+2,answerOptionValueList.get(i).length())+"'><input id='cb-s' class='col3' name='s' type='text' value='"+(answerOptionScoreValueList.get(i)==0?"":answerOptionScoreValueList.get(i))+"'><button class='qt_add'></button></li></ul></div></div></li>";
			...
			myContent+="</li></ul></div></div><input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
}
...
if(questionTypeId.equals("5")){
	...
	/*	Iterator iter = answerOptionValueList.iterator();
		...
		myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='mc-radio boxContainer'><div class='qt_settings clearfix'><i class='icon-radio icons'></i><span class='widgetName'>Multiple choice radio</span><ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li> </ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_multi clearfix'><div class='clearfix'><input class='hidden' name='qt' type='text' value='5'><label class='qt_ansOpt'>Answer Option</label><label class='qt_score'>Score</label></div><ul class='qt_mc_radio qt_multi clearfix widgetsEl'><li class='clearfix hidden'><div class='radioWrapQuest'><input name='multiRadio' type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt require'><input class='qt_score submt' name='s' maxlength=5 type='text' value='' ><button class='qt_add'><button class='qt_remove'></button></li>";
		if(answerOptionValueList !=null)
			myContent+="<li class='clearfix'><div class='radioWrapQuest'><input  name='multiRadio' type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt' value='"+answerOptionValueList.get(0)+"'><input type='text' id='mcr-s' class='qt_score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(0)==0?"":answerOptionScoreValueList.get(0))+"'></li>";
		myContent+="<li class='clearfix'><div class='radioWrapQuest'><input  name='multiRadio' type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt' value='"+answerOptionValueList.get(1)+"'><input type='text' id='mcr-s' class='qt_score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(1)==0?"":answerOptionScoreValueList.get(1))+"'></li>";
		myContent+="<li class='clearfix'><div class='radioWrapQuest'><input  name='multiRadio' type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt' value='"+answerOptionValueList.get(2)+"'><input type='text' id='mcr-s' class='qt_score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(2)==0?"":answerOptionScoreValueList.get(2))+"'><button class='qt_add'></li>";
		for(i = 3; i < answerOptionValueList.size() ; i++){
			
			myContent+="<li class='clearfix'><input class='hidden' name='optionid' type='hidden' value = '"+qc.getAnswerOptionId().get(i)+"~"+qc.getQuestionId()+"'><div class='radioWrapQuest'><input id='radio12' name='multiRadio' type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt' value='"+(i<=answerOptionValueList.size()-1?answerOptionValueList.get(i):"")+"'><input type='text' id='mcr-s' class='qt_score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(i)==0?"":answerOptionScoreValueList.get(i))+"'><button class='qt_add'><button class='qt_remove'></li>";
...
try{
	...
	myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='boxContainer multiple-choice-dropdown clearfix'><div class='qt_settings clearfix'> <i class='icon-dropdown icons'></i><span class='widgetName'>Multiple choice dropdown</span><ul class='controlPanel clearfix'> <li>"+sele+"<li> <button class='btn btn-xs bulk-answer' type='button'>Bulk Answer</button> <div class='bulk-answer-panel dd'> Bulk answer <textarea></textarea><button class='btn btn-xs cancel' type='button'>Cancel</button><button class='btn btn-xs save-bulkanswer' type='button'>Save</button> </div> </li> <li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><span class='qt_No'></span><label class='qt_editBox' for='qt_editBox' title=''></label><input class='hidden' name='qt' type='text' value='6'><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value= '"+questionText+"' /></div><div class='qt_field_opt qt_multiChoice_dd'> <ul> <li class='clearfix'> <div class='multiChoice_dd'> <div class='mc-dropdown-select multiChoice_dd_select'> Select Answer</div> <ul class='mc_dd_opt hide widgetsEl'><li><label class='bulk'>Answer</label><label class= 'score'>Score</label></li><li class='clearfix hidden'><input class='bulk require' name='a' type='text'><input class='score' name='s' maxlength=5 type='text'><button class='qt_add'></button><button class='qt_remove'></button></li>";
	myContent += "<li class='clearfix'><input class='bulk' name='a' type='text' value='"+ answerOptionValueList.get(0) +"'> <input class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(0)==0?"":answerOptionScoreValueList.get(0))+"'></li>";
	myContent += "<li class='clearfix'><input class='bulk' name='a' type='text' value='"+ answerOptionValueList.get(1) +"'> <input class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(1)==0?"":answerOptionScoreValueList.get(1))+"'></li>";
	myContent += "<li class='clearfix'><input class='bulk' name='a' type='text' value='"+ answerOptionValueList.get(2) +"'> <input class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(2)==0?"":answerOptionScoreValueList.get(2))+"'><button class='qt_add'></li>";
	if(answerOptionValueList !=null)
	for(i = 3; i < answerOptionValueList.size() ; i++){
...
myContent+="<div class='clearfix'></div></div></div></div><input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
}
...
try{
	...
	myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='ms-chkbox boxContainer'><div class='qt_settings clearfix'><i class='icon-checkBox icons'></i><span class='widgetName'>Multiple select checkbox</span> <ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li> <li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_multi clearfix'><div class='clearfix'><label class='qt_ansOpt'>Answer</label><label class='qt_score'>Score</label></div><input class='hidden' name='qt' type='text' value='7'><ul class='qt_multiTxtBoxList widgetsEl'><li class='clearfix qt_multiTxtBox_row hidden'><label for='checkbox124'><input name='s1' class='qt_ms_chkbox customCheckboxNewQuest' id='checkbox124' type='checkbox'></label><input class='qt_ansOpt submt' name='a' type='text' value=''><input class='qt_score submt' name='s' maxlength=5 type='text' value='' ><button class='qt_add'></button><button class='qt_remove'></button></li>";
	myContent+="<li class='clearfix'><label for='checkbox124'><input name='s1' class='qt_ms_chkbox customCheckboxNewQuest' id='checkbox124' type='checkbox'></label><input class='qt_ansOpt submt' name='a' type='text' value='"+answerOptionValueList.get(0)+"'><input class='qt_score submt' name='s' maxlength=5 type='text' value='"+((answerOptionScoreValueList.get(0))==0?"":(answerOptionScoreValueList.get(0)))+"'></li>";
	myContent+="<li class='clearfix'><label for='checkbox124'><input name='s1' class='qt_ms_chkbox customCheckboxNewQuest' id='checkbox124' type='checkbox'></label><input class='qt_ansOpt submt' name='a' type='text' value='"+answerOptionValueList.get(1)+"'><input class='qt_score submt' name='s' maxlength=5 type='text' value='"+((answerOptionScoreValueList.get(1))==0?"":(answerOptionScoreValueList.get(1)))+"'></li>";
	myContent+="<li class='clearfix'><label for='checkbox124'><input name='s1' class='qt_ms_chkbox customCheckboxNewQuest' id='checkbox124' type='checkbox'></label><input class='qt_ansOpt submt' name='a' type='text' value='"+answerOptionValueList.get(2)+"'><input class='qt_score submt' name='s' maxlength=5 type='text' value='"+((answerOptionScoreValueList.get(2))==0?"":(answerOptionScoreValueList.get(2)))+"'><button class='qt_add'></li>";
	for(i = 3; i < answerOptionValueList.size() ; i++){
...
/*		Iterator iter = answerOptionValueList.iterator();
	...
	myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='ms-dropdown boxContainer multiple-select-dropdown clearfix'><div class='qt_settings clearfix'><i class='icon-dropdown icons'></i><span class='widgetName'>Multiple select dropdown</span> <input class='hidden' name='qt' type='text' value='8'><ul class='controlPanel clearfix'><li>"+sele+"</li><li> <button class='btn btn-xs bulk-answer' type='button'>Bulk Answer</button> <div class='bulk-answer-panel dd'> Bulk answer <textarea></textarea><button class='btnbtn-xs cancel' type='button'>Cancel</button><button class='btn btn-xs save-bulkanswer' type='button'>Save</button> </div> </li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_multi clearfix multiChoice_dd'><div class='mc-dropdown-select multiChoice_dd_select'> Select Answer</div><div class='mc_dd_opt hide widgetsEl'><div class='clearfix'><label class='qt_ansOpt'>Answer</label><label class='qt_score'>Score</label></div><div class='clearfix hidden'><label></label><input name='s1' type='checkbox' class='customCheckboxNewQuest'><input name='a' type='text' class='bulk'><input type='text' id='msd-s' class='score' name='s' maxlength=5 value='' /><button class='qt_add'></button><button class='qt_remove' ></button></div>";
	if(answerOptionValueList !=null)
		myContent+="<div class='clearfix'><label for='mcheckbox421'></label><input class='checkbox' name='mcheckbox421' id='mcheckbox421' type='checkbox'><input name='a' type='text' class='bulk' value='"+answerOptionValueList.get(0)+"'><input type='text' id='msd-s' class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(0)==0?"":answerOptionScoreValueList.get(0))+"'></div>";
		myContent+="<div class='clearfix'><label for='mcheckbox421'></label><input class='checkbox' name='mcheckbox421' id='mcheckbox421' type='checkbox'><input name='a' type='text' class='bulk' value='"+answerOptionValueList.get(1)+"'><input type='text' id='msd-s' class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(1)==0?"":answerOptionScoreValueList.get(1))+"'></div>";
		myContent+="<div class='clearfix'><label for='mcheckbox421'></label><input class='checkbox' name='mcheckbox421' id='mcheckbox421' type='checkbox'><input name='a' type='text' class='bulk' value='"+answerOptionValueList.get(2)+"'><input type='text' id='msd-s' class='score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(2)==0?"":answerOptionScoreValueList.get(2))+"'><button class='qt_add'></div>";
		for(i = 3; i < answerOptionValueList.size() ; i++){
...
myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='boxContainer'><div class='qt_settings clearfix'><i class='icon-radio icons'></i><span class='widgetName'>Boolean radio</span> <ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button> </div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <div class='checkWrapQuest'><input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><div class='checkWrapClickQuest'></div></div><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_boolean_Radio clearfix'><div class='clearfix'><label class='qt_ansOpt'>Answer</label><label class='qt_score'>Score</label></div><input class='hidden' name='qt' type='text' value='9'><ul>";
if(answerOptionValueList !=null)
for(i = 0; i < answerOptionValueList.size() ; i++){
	
	myContent+="<li class='clearfix'><div class='radioWrapQuest'><input type='radio'><div class='radioWrapClickQuest'></div></div><input name='a' type='text' class='qt_ansOpt' type='text' value='"+(i<=answerOptionValueList.size()-1?answerOptionValueList.get(i):"")+"'><input type='text' id='br-first-s' class='qt_score' name='s' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(i)==0?"":answerOptionScoreValueList.get(i))+"'></li>";
	
}
myContent+="</ul></div></div><input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
}
catch(Exception e){
	e.printStackTrace();
}
...
myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='boxContainer'><div class='qt_settings clearfix'><i class='icon-checkBox icons'></i><span class='widgetName'>Boolean checkbox</span> <ul class='controlPanel clearfix'><li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button> </div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <div class='checkWrapQuest'><input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><div class='checkWrapClickQuest'></div></div><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='hidden' name='qt' type='text' value='10'><input class='q require' name='q' type='text' value='"+questionText+"' /></div><div class='qt_field_opt qt_boolean_chkbox'><div class='clearfix'><label class='qt_ansOpt'>Answer</label><label class='qt_score'>Score</label></div><ul>";
if(answerOptionValueList !=null)
for(i = 0; i < answerOptionValueList.size() ; i++){
...
myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='dateSelection boxContainer'> <div class='qt_settings clearfix'><i class='icon-dateSelection icons'></i><span class='widgetName'>Date selection box</span> <ul class='controlPanel clearfix'> <li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div> <label class='qt_editBox' for='qt_editBox' title=''></label> </input> <span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"' /> </div> <div class='qt_field_opt clearfix'> <div class='clearfix'><input class='hidden' name='qt' type='text' value='11'><label class='qt_ansOpt'>Answer</label> <label class='qt_score'>Score</label></div> <ul> <li class='clearfix'><span class='dateSel'>";
...
myContent+="<div class='customSelectWrapperQuest disabledDates'> <select> <option> yyyy </option> </select> <div class='customSelectClickQuest disabledDates'>yyyy</div></div>    </span>    <input name='s' class='qt_score' maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(0)==0?"":answerOptionScoreValueList.get(0))+"'>  </li>     </ul> </div></div><input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
	}
	catch(Exception e){
		e.printStackTrace();
	}
...
/*	Iterator iter = answerOptionValueList.iterator();
	...
	myContent += "<li class='ui-widget-content ui-draggable ui-draggable-handle canvas-element'><div class='boxContainer dateSelector'><div class='qt_settings clearfix'><i class='icon-datePicker icons'></i><span class='widgetName'>Date picker</span>  <ul class='controlPanel clearfix'> <li>"+sele+"</li><li><span class='qt_each_settings icon-sort "+ ((qc.isMovement() == true) ? "iconDisabled" : "") +"'></span></li><li><span class='qt_each_settings icon-settings'></span><div class='settings-panel dd'><table><tr><td><span class=redTxt>*</span> Mandatory</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionMandatory()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input "+(((qc.getQuestionAttachment()).toString()).equalsIgnoreCase("true")?"checked":"unchecked")+" name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= '"+(qc.getQuestionTag()==null?"":qc.getQuestionTag())+"'></td> </tr> </table><button class='btn btn-xs cancel' type='button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button></div></li><li>"+qidText+"<input type='hidden' class='quesid' value = '"+qc.getQuestionId()+"'><span class='qt_each_settings "+deleteIcon+"'></span></span><input type='hidden' class='qrid' name='qrid' type='text' value = '"+qc.getQuestionnaireId()+"'></li></ul></div><div class='clearfix'><div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><label class='qt_editBox' for='qt_editBox' title=''></label><input class='hidden' name='qt' type='text' value='12'><span class='qt_No'></span><input class='hidden hq' name='section1' value='sectionTitle"+ st +"51'><input class='q require' name='q' type='text' value='"+questionText+"'></div><div class='qt_field_opt clearfix qt_dp'> <div class='clearfix'> <span class='qt_ansOpt'>Answer</span><span class= 'qt_score qtscore'>Score</span> </div> <ul> <li class='clearfix'><input class='datepicker' disabled placeholder='dd/mm/yyyy' type='text' name='a' value='"+answerOptionValueList.get(0)+"'><i class='dp-disabled'></i><input class='qt_score submt'  name='s'  maxlength=5 type='text' value='"+(answerOptionScoreValueList.get(0)==0?"":answerOptionScoreValueList.get(0))+"'></li> </ul></div></div><input type='hidden' name='draggableArrow1' class='draggableArrow' value='"+qc.isMovement()+"'></li>";
	}
	catch(Exception e){
		e.printStackTrace();
	}
...
<%-- <h2 class="text-center"> <strong>${msg}!</strong></h2> --%>
  ...
  if(null !=  session.getAttribute("msg")){
   ...
   %>
    <div class="status-warn templateError"><%=value %></div>
   <%
...
<div class="container qstContainer">
 ...
 <div class="fl"><span class="customInput customCheckBox selectall"><input type="checkbox" id="selectAll" style="display: none"><label for="selectAll">Select All</label></span></div><div class="fr"><!-- <button class="btn btn-xs" type="button">Scoring</button> --><form action="./getbranchedquestions?id=1"><!-- <button class="btn btn-xs" type="submit">Branching</button> --></form></div>
  <div class="fr"><button class="btn btn-xs addBank save1" type="button" disabled="disabled">Add to bank</button><button class="btn btn-xs insertBank save1" type="button">Insert from Bank</button><button class="btn btn-xs something" type="button">Branching</button></div>
  <div class="hidden quesId"><%=questId%></div>
  </div>
  
  </div>
 <div class="setupQuestContainer clearfix">
  <div class="panels col-md-3">
    ...
    <div id="questBank" class="tab_content">
     <ol>
  	  <li><a href="#">Sample Question 1</a></li>
  	  <li><a href="#">Sample Question 2</a></li>
  	  <li><a href="#">Sample Question 3</a></li>
  	  <li><a href="#">Sample Question 4</a></li>
  	  <li><a href="#">Sample Question 5</a></li>
  	  <li><a href="#">Sample Question 6</a></li>
  	  <li><a href="#">Sample Question 7</a></li>
	    </ol>
    </div>
    <div id="questTemplate" class="tab_content">
      <ol>
...
<form name="submitquestionnaire" id="submit-questionnaire" method="POST">
  ...
  <div class="moveDisabled status-warn" style="display:none">Your branching will get affected.</div>
  <!-- Dynamic Tabs -->
   <c:choose>
...
<div class="btns-fr"><form class="deleteFunction" method="post" action="./deletequestionnaire"><input type="hidden" class="quesId" name="questionnaireId" value="<%=questId%>" /><button class="btn closer delete">Delete</button> </form><!-- <span class="pipeline"></span> --><button class="btn fr save1">Save</button></div>
...
<div class="deleteBranchedQuestion questPopup">        
    <ul>
      <li style="text-align:center">Your Branching gets Affected Question cannot be deleted</li>    
     <li>    
     <button type="button" class="btn btn-xs bBtn closePopup" name="yes">Ok</button>
     </li>
    </ul>    
</div>

<div class="moveQuestion questPopup">        
    <ul>
      <li style="text-align:center">As your question is already branched, it cannot be moved</li>    
     <li>    
     <button type="button" class="btn btn-xs bBtn closePopup" name="yes">Ok</button>
     </li>
    </ul>    
...
jQuery('.something').on('click',function() {
 ...
 //   //alert("ID Value is:"+brId);
    ...
    document.branch.action = "/partnerintegrity/getbranchedquestions";
...
case "single-text-box" : return draggableId = "<div class='qt_settings clearfix'><i class='icon-sTxtBox icons'></i><span class='widgetName'>Single Text Box</span> <ul class='controlPanel clearfix'> <li>${categoryValues}</li> <li><span class='qt_each_settings icon-sort'></span></li> <li> <span class='qt_each_settings icon-settings'></span> <div class='settings-panel dd'> <table> <tr> <td>Mandatory <span class='redTxt'>*</span></td> <td><label class='switch-light switch-slider'><input name='mCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class='switch-light switch-slider'><input name='aCheck' type='checkbox' /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type='text' class='tag' name='tag' value= ''></td> </tr> </table><button class='btn btn-xs cancel' type= 'button'>Cancel</button><button class='btn btn-xs save fr' type='button'>Save</button> </div> </li> <li><span class='qt_each_settings icon-delete'></span></li> </ul></div><div class='clearfix ques'> <div class='quesCheckbox'> <input name='question' type='checkbox' class='customCheckboxNewQuest questionQ'><label for='question'></label> </div><span class='qt_No'></span><label class='qt_editBox' for='qt_editBox' title=''></label><input class='hidden' name='qt' type='text' value= '1'><input class='hidden hq' name='section1' value=''><input class='q require' name='q' type='text'></div><div class='qt_field_opt clearfix'> <div class='clearfix'> <span class='qt_ansOpt'>Answer</span> </div> <ul> <li class='clearfix'><input class='qt_ansOpt' name='a' type= 'text' readOnly='true'></li> </ul></div>"; break;		
...
break; 
	...
	case "numeric-box" : return draggableId = '<div class="qt_settings clearfix"> <i class="icon-nBox icons"></i><span class="widgetName">Numeric box</span><ul class="controlPanel clearfix"> <li>${categoryValues}</li> <li><span class="qt_each_settings icon-sort"></span></li> <li> <span class="qt_each_settings icon-settings"></span> <div class="settings-panel dd"> <table> <tr> <td>Mandatory <span class="redTxt">*</span></td> <td><label class="switch-light switch-slider"><input name="mCheck" type="checkbox" /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class="switch-light switch-slider"><input name="aCheck" type="checkbox" /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type="text" class="tag" name="tag" value= ""></td> </tr> </table><button class="btn btn-xs cancel" type= "button">Cancel</button><button class="btn btn-xs save fr" type="button">Save</button> </div> </li> <li><span class="qt_each_settings icon-delete"></span></li> </ul></div><div class="clearfix"> <div class="quesCheckbox"> <input name="question" type="checkbox" class="customCheckboxNewQuest questionQ"><label for="question"></label> </div><span class="qt_No"></span><label class="qt_editBox" for="qt_editBox" title=""></label><input class="hidden" name="qt" type="text" value= "3"><input class="hidden hq" name="section1" value=""><input class="q require" name="q" type="text"></div><div class="qt_ansOpt clearfix" style="padding:10px 10px 0 45px"> Answer</div><div class="clearfix" style="padding:10px 10px 20px 45px"> <input class="qt_ansOpt" name="a" type="text" readonly="true"></div><div class="qt_field_opt qt_multi clearfix"> <label class="setRange">Set range</label> <div class="clearfix"></div> <div class="clearfix"> <span class="col1">From</span><span class="col2">To</span><span class= "col3 qt_score">Score</span> </div> <ul class="qt_multiTxtBoxList widgetsEl"> <li class="clearfix qt_multiTxtBox_row hidden"><input class= "col1" name="from" type="text"><input class="col2" name="to" type="text"><input class="col3 qt_score" name="s" maxlength=5 type= "text"><button class="qt_add"></button><button class= "qt_remove"></button></li> <li class="clearfix qt_multiTxtBox_row"><input class="col1" name="from" type="text"><input class="col2" name="to" type= "text"><input class="col3 qt_score" name="s" maxlength=5 type="text"><button class= "qt_add"></button></li> </ul></div>';
	break;
	...
	case "boolean-radio" : return draggableId = '<div class="qt_settings clearfix"><i class="icon-radio icons"></i><span class="widgetName">Boolean radio</span> <ul class="controlPanel clearfix"> <li>${categoryValues}</li> <li><span class="qt_each_settings icon-sort"></span></li> <li> <span class="qt_each_settings icon-settings"></span> <div class="settings-panel dd"> <table> <tr> <td>Mandatory <span class="redTxt">*</span></td> <td><label class="switch-light switch-slider"><input name="mCheck" type="checkbox" /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class="switch-light switch-slider"><input name="aCheck" type="checkbox"><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type="text" class="tag" name="tag" value= ""></td> </tr> </table><button class="btn btn-xs cancel" type= "button">Cancel</button><button class="btn btn-xs save fr" type="button">Save</button> </div> </li> <li><span class="qt_each_settings icon-delete"></span></li> </ul></div><div class="clearfix"><div class="quesCheckbox"> <div class="checkWrapQuest"><input name="question" type="checkbox" class="customCheckboxNewQuest questionQ"><div class="checkWrapClickQuest"></div></div><label for="question"></label> </div><span class="qt_No"></span><label class="qt_editBox" for="qt_editBox" title=""></label><input class="hidden" name="qt" type="text" value= "9"><input class="hidden hq" name="section1" value=""><input class="q require" name="q" type= "text"></div><div class="qt_field_opt qt_boolean_Radio clearfix"> <div class="clearfix"> <span class="qt_ansOpt">Answer Option</span><span class= "qt_score">Score</span> </div> <ul> <li class="clearfix"><div class="radioWrapQuest"><input type="radio"><div class="radioWrapClickQuest"></div></div><input class= "qt_ansOpt require" name="a" type="text"><input class="qt_score" name="s" maxlength=5 type= "text"></li> <li><div class="radioWrapQuest"><input type="radio"><div class="radioWrapClickQuest"></div></div><input class="qt_ansOpt require" name= "a" type="text"><input class="qt_score" name="s" maxlength=5 type="text"></li> </ul></div>'; break; 
	
	case "boolean-checkbox" : return draggableId = '<div class="qt_settings clearfix"><i class="icon-checkBox icons"></i><span class="widgetName">Boolean checkbox</span> <ul class="controlPanel clearfix"> <li>${categoryValues}</li> <li><span class="qt_each_settings icon-sort"></span></li> <li> <span class="qt_each_settings icon-settings"></span> <div class="settings-panel dd"> <table> <tr> <td>Mandatory <span class="redTxt">*</span></td> <td><label class="switch-light switch-slider"><input name="mCheck" type="checkbox" /><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Allow Attachment</td> <td><label class="switch-light switch-slider"><input name="aCheck" type="checkbox"><span><span>No</span><span>Yes</span></span><a></a></label></td> </tr> <tr> <td>Tag</td> <td><input type="text" class="tag" name="tag" value= ""></td> </tr> </table><button class="btn btn-xs cancel" type= "button">Cancel</button><button class="btn btn-xs save fr" type="button">Save</button> </div> </li> <li><span class="qt_each_settings icon-delete"></span></li> </ul></div><div class="clearfix"> <div class="quesCheckbox"> <div class="checkWrapQuest"><input name="question" type="checkbox" class="customCheckboxNewQuest questionQ"><div class="checkWrapClickQuest"></div></div><label for="question"></label> </div><span class="qt_No"></span><label class="qt_editBox" for="qt_editBox" title=""></label><input class="hidden" name="qt" type="text" value= "10"><input class="hidden hq" name="section1" value=""><input class="q require" name="q" type= "text"></div><div class="qt_field_opt qt_boolean_chkbox"> <div class="clearfix"> <span class="qt_ansOpt">Answer</span><span class= "qt_score">Score</span> </div> <ul> <li class="clearfix"><input type="checkbox" name="sr" class="customCheckboxNewQuest"><input class="qt_ansOpt require" name="a" type="text"><input class= "qt_score" name="s" maxlength=5 type="text"></li> </ul></div>'; break;
...
jQuery('#submit-questionnaire').on('click', '.branch-delete', function(e) {
	  e.stopPropagation();
	  jQuery(".settings-panel").hide();
		var $this = $(this);
		$('.qstText').text("question");
		jQuery('.popupBg, .deleteBranchedQuestion').show();
		jQuery('body').on('click', '.btn ',function(e) {
			if(jQuery(this).hasClass('bBtn')){
				$('.popupBg, .deleteBranchedQuestion, .errorMsg').hide();
			}
...
//for checkbox design
 ...
 jQuery('.qt_remove').on('click', function() {
     ...
     jQuery('body').on('mousedown', '.icon-sort', function() {
    	   if(jQuery(this).hasClass('iconDisabled')) {
    	      jQuery('.moveQuestion, .popupBg').show();
    	   } else {
    	      jQuery('.moveQuestion, .popupBg').hide();
    	   }
    	});
