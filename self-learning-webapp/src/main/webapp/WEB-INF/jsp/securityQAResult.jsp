...
<br><br>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<form method="post" action="/partnerintegrity/securityqa">
                   <div class="alert alert-success">
                    ...
                    <br/>
                     <%-- <div class="row mb10">
                       <!--  <div class="col-sm-4">
                             <button class="btn btn-danger" name="back" type="submit">Go back to add a new user</button>    
                        </div> -->
                        
                      <div class="col-sm-4">
                      </div>
      							<c:if test="${successMessage eq 'success'}">
      							<div class="col-sm-5" align="center">
                           			 <button class="btn btn-success btn-block" type="submit" name="security">Click to Create Security Questions</button>    
                        		</div>      							
      							<br />     					
      						<br />      						
      					</c:if>              
		...
		<br>
<div class="text-center">Copyright © 2014 The Red Flag Group. All
		rights reserved.</div>
...
function check()
{
        ...
        if (password.passwordStr.value == "")
        {
        	alert("Please enter password !!");
        	password.passwordStr.focus();
        	return false;
        }
        if (password.confirmpassword.value == "")
        {
        	alert("Please enter confirm password !!");	
        	password.confirmpassword.focus();
        	return false;
        }else if(password.passwordStr.value != password.confirmpassword.value ){
