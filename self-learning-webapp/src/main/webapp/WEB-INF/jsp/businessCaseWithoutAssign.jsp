		...
		<h1>Data Collection Summary</h1>
					...
					<div class="radio-container">
						<div class="radio-questionnire customInput customRadio">
							...
							<input type="radio" id="qst" name="deftype" class="radioBtn" value="Q~idfef"><label for="qst">Questionnaires</label>
							<input type="radio" id="bCase" name="deftype" class="radioBtn" value="B~idfef" checked><label for="bCase">Business case</label>
