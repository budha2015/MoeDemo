...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">    
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href=""><i class="glyphicon glyphicon-plane"></i> <span>Onboarding</span></a>
          <ul class="children">
            <li><a href="#"><i class="fa fa-caret-right"></i> New Onboarding</a></li>
            <li><a href="#"><i class="fa fa-caret-right"></i> Data Collection</a></li>
            <li><a href="#"><i class="fa fa-caret-right"></i> Validation</a></li>
          </ul>
        </li>
        <li><a href=""><i class="glyphicon glyphicon-map-marker"></i> <span>3P Organisations</span></a></li>
        <li><a href="#"><i class="glyphicon  glyphicon-ok"></i> <span>Remediations</span></a></li>
        <li><a href=""><i class="glyphicon glyphicon-pencil"></i> <span>Contracts</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="alert alert-success" >
      <h2 class="text-center">  Record Saved successfull ! </h2>
